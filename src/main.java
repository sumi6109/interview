...
//graph.BFS(white1);
        ...
        LinkedNode secondSecond =new LinkedNode(30,null);
        LinkedNode firstSecond =new LinkedNode(15,secondSecond);
        LinkedNode startSecond = new LinkedNode(10,firstSecond);
        LinkedList list1 = new LinkedList(startSecond);
        list1.add(firstSecond);
        list1.add(secondSecond);
    LinkedListIntersection linkedListIntersection = new LinkedListIntersection();
        int i = linkedListIntersection.intersectValue(start, startSecond);
        System.out.println("i = " + i);
